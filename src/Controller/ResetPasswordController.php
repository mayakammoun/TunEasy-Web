...
class ResetPasswordController extends AbstractController
{
   ...
   public function __construct(EntityManagerInterface $entityManager){
    ...
    public function index(Request $request): Response
    {
        ...
        if($request->get('email')){
           ...
           if($user){
               ...
               $content="Bonjour ".$user->getFirstname()."<br/> Vous avez demandé la réinitialisation de votre Mdp </br></br>";
               $content .="Veuillez cliquer sur le lien suivant pour <a href = '".$url."'> modifier votre mot de passe</a>";
               $mail=new Mail();
    ...
    public function update(Request $request,
                           $token,UserPasswordEncoderInterface $encoder):Response
    {
